#!/usr/bin/perl
# iou2net by "einval"; upstream maintained by Jeremy L. Gaddis:
# https://github.com/jlgaddis/iou2net
# GNU GPL version 2; see licenses/iou2net-GPL-2.0.txt.
# Weblab modifications (notice added 2026-09-16): create the socket base
# directory before opening local sockets; add attribution and license notice.
