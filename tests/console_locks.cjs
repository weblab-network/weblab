...
(async () => {
  ...
  try {
    ...
    await first.locator('#lock-console').check(); await mine(first); await observing(second);
    ...
    await first.locator('#lock-console').check();
    ...
    await second.locator('#lock-console').uncheck();
    ...
    await second.locator('#lock-console').check(); await mine(second);
