...
plus saved configuration overlays generated by Weblab. Its upstream redistribution
notice is preserved in [Virtual-EXOS.txt](licenses/Virtual-EXOS.txt). The binary
and derived disks are build artifacts, not source-repository files. Metadata and
